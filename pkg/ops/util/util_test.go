...
func TestMarshal(t *testing.T) {
	...
	_ = expectedStringDict.SetKey(starlark.String("foo"), starlark.MakeInt(42))

	expectedIntDict := starlark.NewDict(1)
	_ = expectedIntDict.SetKey(starlark.MakeInt(42*2), starlark.MakeInt(42))

	ct, _ := (&customType{42}).MarshalStarlark()
	expectedStrDictCustomType := starlark.NewDict(2)
	_ = expectedStrDictCustomType.SetKey(starlark.String("foo"), starlark.MakeInt(42))
	_ = expectedStrDictCustomType.SetKey(starlark.String("bar"), ct)
...
func TestUnmarshal(t *testing.T) {
	...
	_ = strDict.SetKey(starlark.String("foo"), starlark.MakeInt(42))

	intDict := starlark.NewDict(1)
	_ = intDict.SetKey(starlark.MakeInt(42*2), starlark.MakeInt(42))

	ct, _ := (&customType{42}).MarshalStarlark()
	strDictCT := starlark.NewDict(2)
	_ = strDictCT.SetKey(starlark.String("foo"), starlark.MakeInt(42))
	_ = strDictCT.SetKey(starlark.String("bar"), ct)
	...
	cases := []struct {
		...
		{ct, map[string]interface{}{"foo": 42}, ""},
		{strDictCT, map[string]interface{}{"foo": 42, "bar": map[string]interface{}{"foo": 42}}, ""},
		{starlark.NewList([]starlark.Value{starlark.MakeInt(42), ct}), []interface{}{42, map[string]interface{}{"foo": 42}}, ""},
